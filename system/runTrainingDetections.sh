...
scoreThreshold="-10.0"
resultsOutput=/home/caicedo/data/cnnPatches/trainingDetections/
# Evaluation
# Make detections in the training set:
...
#for category in aeroplane; do
  ...
  testGroundTruth="/home/caicedo/data/cnnPatches/lists/2007/trainval/"$category"_gt_bboxes.txt"
